            ...
            <tr class="hover:bg-base-100/40">
                ...
                <td class="py-4 px-4 align-middle">
                    <div class="flex items-center gap-2">
                        <x-feathericon-mail class="w-4 h-4 text-primary" />
                        <span class="font-medium text-neutral-700">Konsumsi</span>
                    </div>
                </td>
                <td class="py-4 px-4 align-middle">
                ...
                <td class="py-4 px-4 align-middle">
                    <a href="{{ route('dashboard.consumption.show', $item->id) }}" class="text-primary font-semibold">View</a>
                </td>
            </tr>
        @endforeach
    </tbody>
