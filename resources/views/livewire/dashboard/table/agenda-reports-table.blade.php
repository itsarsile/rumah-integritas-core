            ...
            <tr class="hover:bg-base-100/40 border-b border-base-200 bg-white">
                ...
                <td class="p-2 align-middle">
                    <div class="flex items-center gap-2">
                        <x-feathericon-calendar class="w-4 h-4 text-primary" />
                        <span class="font-medium text-neutral-700">Agenda</span>
                    </div>
                </td>
                <td class="p-2 align-middle">
                ...
                <td class="p-2 align-middle">
                    <a href="{{ route('dashboard.agenda.show', $item->id) }}" class="text-neutral-500 flex items-center gap-1">
